...
input values to the resulting neighbor array creating a raster of classified pixel values.
...
class NNClassifier():
    def __init__(self):
        ...
        self.description = 'This raster function performs nearest neighbors analysis using' \
                           ' scikit-learn then maps the input values to the resulting' \
                           ' neighbor array creating a raster of classified pixel values.'
