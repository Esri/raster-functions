...
class NDVI():
    ...
    def updatePixels(self, **pixelBlocks):
        ...
        red = np.array(inBlock[0], dtype='float')               # extractbands ensures first band is Red.
        ir = np.array(inBlock[1], dtype='float')                # extractbands ensures second band is Infrared
